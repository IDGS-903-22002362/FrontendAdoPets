          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <p className="text-lg text-gray-900">{user?.nombreCompleto || 'No especificado'}</p>
              </div>
              <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {availableActions.map((action) => (
                  <button
                    ...
                    className={`bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all ${getColorClasses(action.color)} text-center group`}
                  >
                    <div className={`w-12 h-12 mx-auto mb-3 rounded-full ${getColorClasses(action.color)} flex items-center justify-center`}>
                      <svg
                        className="w-6 h-6"
                        fill="none"
                        stroke="currentColor"
